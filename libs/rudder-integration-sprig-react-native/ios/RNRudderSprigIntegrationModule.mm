...
@implementation RNRudderSprigIntegrationModule
...
- (instancetype)init {
  self = [super init];
  if (self) {
    moduleImpl = [[RNRudderSprigIntegrationModuleImpl alloc] init];
  }
  return self;
}
...
- (std::shared_ptr<facebook::react::TurboModule>)getTurboModule:(const facebook::react::ObjCTurboModule::InitParams &)params {
  return std::make_shared<facebook::react::NativeSprigBridgeSpecJSI>(params);
}
